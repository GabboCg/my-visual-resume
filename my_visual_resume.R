VisualResume::VisualResume(
  ...
  timeline.labels = c("Educación", "Teaching"),
  timeline = data.frame(title = c("Universidad de Chile", "Universidad de Chile", "U of Basel", "Max Planck Institute", "Old Van", "Gray Matter", "Sandia Laboratories", "J.P. Wynne High School", "A1A Car Wash"),
